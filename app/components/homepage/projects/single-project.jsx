...
const SingleProject = ({ project }) => {
  ...
  dangerouslySetInnerHTML={{
    __html: `<h2 class='text-[#EFF3F4] not-italic font-semibold text-[1.525rem] leading-[110%] text-center capitalize'>${name}</h2>`,
  }}
/>
        <div className="p-6">
          <Image
      ...
      <p className="absolute w-[90%] md:w-[85%] md:min-h-[150px] translate-x-[-110%] transition-transform duration-[0.9s] p-6 leading-[110%] rounded-[0_20px_20px_0] left-0 top-24 md:top-10 bg-[#0f0b24]  text-[#EFF3F4] translate-y-[25%] md:translate-y-[50%] group-hover:translate-x-[-2%] text-sm md:text-base">
        {description}
      </p>
